            ...
            <div class="profile-content">
                <form class="form-horizontal" id="form1" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-7">
                            <input class="form-control" type="password" name="password" data-validation="server" data-validation-url="<?php echo base_url() . 'auth/pass_check/' . $user->id; ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-lg-2">Nhắc lại mật khẩu </label>
                        <div class="col-lg-7">
                            <input class="form-control" type="password"name="password_confirm" data-validation="confirmation" data-validation-confirm="password" data-validation-error-msg="Mật khẩu lặp lại không đúng">
                        </div>
                    </div>
                    <?php
                    $json = json_encode(array('user' => $user->salt));
                    ?>
                    <div class="form-group">
                        <label class="control-label col-lg-2">Mật khẩu cũ: </label>
                        <div class="col-lg-7">
                            <input class="form-control" type="password" name="passwordold" data-validation="server" data-validation-url="<?php echo base_url() . 'auth/pass_check/' . $user->id; ?>">
                        </div>
                    </div>
                    <div class="form-group">
