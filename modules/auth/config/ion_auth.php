 ...
 */
$config['site_title'] = "3ctuts.com";       // Site Title, example.com
$config['admin_email'] = "lytranuit@gmail.com"; // Admin Email, admin@example.com
$config['default_group'] = 'members';           // Default group, use name
$config['admin_group'] = 'admin';             // Default administrators group, use name
$config['identity'] = 'username';
$config['identity_forgot'] = 'email';   // A database column which is used to login with
